...
import com.codenome.highlightview.extensions.dimen
import com.codenome.highlightview.internal.viewProperty

class OverlayView @JvmOverloads constructor(context: Context, attr: AttributeSet? = null, defStyle: Int = 0) : View(context, attr, defStyle) {
    ...
    var overlayShape: OverlayShape by viewProperty(OverlayShape.OverlayOval)

    var bitmap: Bitmap? = null
    val paint = Paint(Paint.ANTI_ALIAS_FLAG)
    val paddingColorPaint = Paint(Paint.ANTI_ALIAS_FLAG)
    ...
    private fun addFocusViewInOverlay(anchorView: View?, canvas: Canvas) {
        anchorView?.let { anchor ->
            ...
            when (val overlay = overlayShape) {
                ...
                is OverlayShape.OverlayRoundRect -> {
